...
public class ZooKeeperLeaderElection {
    ...
    public synchronized Vote lookForLeader() {
        ...
        while (this.myPeerServer.getPeerState().equals(ZooKeeperPeerServer.ServerState.LOOKING )|| this.myPeerServer.getPeerState().equals(ZooKeeperPeerServer.ServerState.OBSERVER)) {
            ...
            try {
                ...
                if (msg == null){
                  logger.info("Server on port  "+ myPeerServer.getUdpPort() +"  msg was null. trying again... ");
            ...
            if (msg == null) continue; // if we dont have a msg, keep trying...
            ...
            if (notification.getPeerEpoch() < this.proposedEpoch)  this.proposedEpoch = notification.getPeerEpoch();
                ...
                case LEADING:
                   ...
                   if (this.proposedLeader ==myPeerServer.getServerId()) this.proposedLeader = notification.getProposedLeaderID();
                    ...
                    if (haveEnoughVotes(receivedNotificatoins, new Vote(this.proposedLeader, this.proposedEpoch))) {
                        ...
                        logger.info(this.myPeerServer.getServerId() +" accepting election. new leader: " + this.proposedLeader);
                        acceptElectionWinner(notification);
                        return new Vote(proposedLeader, proposedEpoch);
                    }
    ...
    private Vote acceptElectionWinner(ElectionNotification n) {
        ...
        incomingMessages.clear();
      //  logger.info("  incomingMessages.clear(); on server ID " + this.myPeerServer.getServerId());
           return winner;
    }
